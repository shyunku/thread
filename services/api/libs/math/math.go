...
import (
	...
	"math"
	"math/rand"
	ThreadTypes "thread_api/libs/types"
	"reflect"
)
...
func Min(numbers ...interface{}) float64 {
	...
	for _, number := range numbers {
		assertedNumber, err := ThreadTypes.AsFloat64(number)
		if err != nil {
			continue
		}
...
func SafeMin(numbers ...interface{}) (interface{}, error) {
	...
	pivot, err := ThreadTypes.AsFloat64(numbers[0])
	if err == nil {
		return pivot, err
	}
	...
	targetValue, _ := ThreadTypes.AsType(pivot, targetType)
